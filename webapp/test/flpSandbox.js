		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Nachrichten Cockpit App",
									"targetURL": "#decittinachrichtencockpit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"decittinachrichtencockpit-display": {
								"semanticObject": "decittinachrichtencockpit",
								"action": "display",
								"description": "Nachrichten Cockpit App",
								"title": "Nachrichten Cockpit App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=de.citti.nachrichtencockpit",
									"url": sap.ui.require.toUrl("de/citti/nachrichtencockpit")
								}
							}
						}
					}
